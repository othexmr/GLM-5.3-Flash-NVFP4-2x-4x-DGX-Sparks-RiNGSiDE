...
class Parser:
    ...
    @property
    def tool_call_truncated(self) -> bool:
        """Whether the active tool parser had to repair an unfinished call."""
        return bool(getattr(self._tool_parser, "tool_call_truncated", False))
