...
# indexed by spec-batch position instead of the KV page.
# Modified by the GLM-5.3 RiNGSiDE recipe (othexmr): exact-landing final column of the RecoverSSM commit.
...
class KDARecoverSSMCommitContext:
    ...
    def create(
        ...
        *,
        ...
        correction_caches = [layer.recoverssm_records[0] for layer in layers]
        kg_caches = [layer.recoverssm_records[1] for layer in layers]
